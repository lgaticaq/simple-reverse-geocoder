    ...
    reverse: data => {
      return new Promise((resolve, reject) => {
        if (data.lon === -70.5171743 && data.lat -33.3608387) {
          ...
          reject(new Error('Status is OVER_QUERY_LIMIT. You have exceeded your daily request quota for this API. We recommend registering for a key at the Google Developers Console: https://console.developers.google.com/apis/credentials?project=_'));
        }
      });
    }
  };
  ...
  describe('without cache', () => {
    ...
    describe('clearCache', () => {
      it('should return undefined', done => {
        rg.clearCache(-33.3608387, -70.5171743).then(data => {
  ...
  describe('with cache', () => {
    ...
    describe('getAddress', () => {
      ...
      it('should return a valid address with valid apiKey', done => {
        ...
        rg.getAddress(loc, '1234567').then(data => {
